...
function switchCity() {
	if (citySel.value in citys) {
		distSel.innerHTML = '';
		for (dist of citys[citySel.value])
			distSel.innerHTML = distSel.innerHTML + `<option>${dist}</option>`;
	} else {
		distSel.innerHTML = '<option value="" disabled>請先選擇縣市</option>';
	}
}

const citySel = document.getElementById('city');
const distSel = document.getElementById('dist');
citySel.onchange = switchCity;
